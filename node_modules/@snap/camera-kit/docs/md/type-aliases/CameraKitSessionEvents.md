...
from the associated CameraKitSession.
    ...
    - [LensVideoPlaybackMutedError](LensVideoPlaybackMutedError.md) Video playback was muted due to browser autoplay policies.
The lens continues to render. Applications should show an unmute button.
