...
</div><div class="tsd-comment tsd-typography"></div></section><section class="tsd-panel tsd-member"><a id="logger" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><code class="tsd-tag">Optional</code><span>logger</span><a href="#logger" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3><div class="tsd-signature"><span class="tsd-kind-property">logger</span><span class="tsd-signature-symbol">?:</span> <a href="../types/Logger.html" class="tsd-signature-type tsd-kind-type-alias">Logger</a> <span class="tsd-signature-symbol">|</span> <span class="tsd-signature-type">&quot;noop&quot;</span> <span class="tsd-signature-symbol">|</span> <span class="tsd-signature-type">&quot;console&quot;</span></div><div class="tsd-comment tsd-typography"><p>Determine where to print CameraKit log messages. By default no logs will be printed.</p>
<p>CameraKit emits log messages to help diagnose and root cause issues that may occur during the development of a
host application. The printing of these can be controlled via the following options:</p>
<ul>
<li><code>&quot;noop&quot;</code>: log messages are ignored.</li>
<li><code>&quot;console&quot;</code>: log messages are printed to console.</li>
<li>A custom <a href="../types/Logger.html" class="tsd-kind-type-alias">Logger</a> instance can be provided to integrate with an existing logging system.</li>
</ul>
</div><div class="tsd-comment tsd-typography"></div></section><section class="tsd-panel tsd-member"><a id="loglevel" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><code class="tsd-tag">Optional</code><span>log<wbr/>Level</span><a href="#loglevel" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3><div class="tsd-signature"><span class="tsd-kind-property">logLevel</span><span class="tsd-signature-symbol">?:</span> <a href="../types/LogLevel.html" class="tsd-signature-type tsd-kind-type-alias">LogLevel</a></div><div class="tsd-comment tsd-typography"><p>Log only if a logged entry level is greater than or equal to this level. Here is the order of levels:
...
user analytics.</p>
</div><div class="tsd-comment tsd-typography"></div></section><section class="tsd-panel tsd-member"><a id="fonts" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><code class="tsd-tag">Optional</code><span>fonts</span><a href="#fonts" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3><div class="tsd-signature"><span class="tsd-kind-property">fonts</span><span class="tsd-signature-symbol">?:</span> <a href="../types/FontConfig.html" class="tsd-signature-type tsd-kind-type-alias">FontConfig</a><span class="tsd-signature-symbol">[]</span></div><div class="tsd-comment tsd-typography"><p>An array of fonts to be used by Camera Kit for text rendering.</p>
...
correctly.</p>
<p>When rendering text, Camera Kit tries each font in array order until it finds the needed glyph.
The built-in font is always available — even with an empty array or no <code>&quot;default&quot;</code> entry, it is
checked after all provided fonts. Use <code>&quot;default&quot;</code> to control its position in the lookup order.</p>
</div><div class="tsd-comment tsd-typography"><div class="tsd-tag-example"><h4 class="tsd-anchor-link"><a id="example-1" class="tsd-anchor"></a>Example<a href="#example-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h4><pre><code class="ts"><span class="hl-7">// The built-in font will be checked before `fallbackFont`, but after `emojiFont`.</span><br/><span class="hl-11">fonts</span><span class="hl-1">: [</span><br/><span class="hl-1">  { </span><span class="hl-0">name:</span><span class="hl-1"> </span><span class="hl-3">&#39;EmojiFont&#39;</span><span class="hl-1">, </span><span class="hl-0">data:</span><span class="hl-1"> </span><span class="hl-0">emojiFontArrayBuffer</span><span class="hl-1"> },</span><br/><span class="hl-1">  </span><span class="hl-3">&quot;default&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">  { </span><span class="hl-0">name:</span><span class="hl-1"> </span><span class="hl-3">&#39;FallbackFont&#39;</span><span class="hl-1">, </span><span class="hl-0">data:</span><span class="hl-1"> </span><span class="hl-0">fallbackFontArrayBuffer</span><span class="hl-1"> },</span><br/><span class="hl-1">]</span>
</code><button type="button">Copy</button></pre>
