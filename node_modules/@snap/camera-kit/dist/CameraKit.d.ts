...
export declare const cameraKitFactory: {
    (args_0: LensRepository, args_1: MetricsEventTarget, args_2: {
        ErrorType: {
            ...
            VideoPlaybackFailed: import("./lens-core-module/generated-types").LensCoreEnumValue;
            VideoPlaybackMuted: import("./lens-core-module/generated-types").LensCoreEnumValue;
        };
        AssetType: {
